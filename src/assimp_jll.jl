...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import assimp_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("54ae6823-98c6-5a7c-8365-5a43b909f91f"))
platforms = [Pkg.Artifacts.unpack_platform(e, "assimp", artifacts_toml) for e in artifacts["assimp"]]
...
if best_platform === nothing
    @debug("Unable to load assimp; unsupported platform $(triplet(platform_key_abi()))")
else
